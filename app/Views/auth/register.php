                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= route_to('register') ?>" method="post">
                                ...
                                <div class="form-group">
                                    <select class="form-control rounded-pill" style="font-size: .8rem;" id="select-role" name="role">
                                ...
                                <div class="form-group <?= old('role') != 1 ? 'd-none' : '' ?>" id="id-number-input">
                                    <input type="text" class="form-control form-control-user <?php if (session('errors.nim')) : ?>is-invalid<?php endif ?>" name="id_number" placeholder="<?= lang('Auth.nim') ?>" value="<?= old('nim') ?>">
                                </div>
